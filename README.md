...
[Download mmarch v1.1](https://github.com/might-and-magic/mmarch/releases/download/v1.1/mmarch.zip)
...
For some archive format, some files have different file extensions in the archive and as extracted files out of the archive. You can use either extension to refer to the file. Below is the list (same extension is used if not listed):
...
* [2020-03-14] v1.1: support palette; deal with in-archive & extracted file extension differences and the "cannot find the path specified" problem caused by it
